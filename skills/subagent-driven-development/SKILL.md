...
digraph process {
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Use humanpowers:finishing-a-development-branch";
}
```
...
- **humanpowers:requesting-code-review** - Code review template for reviewer subagents
